...
NSYNC=${TF_INC}/external/nsync/public
...
echo "--------------------------------------------------"
echo "Compile roi pooling layer"
...
g++ -std=c++11 -shared -o roi_pooling.so roi_pooling_op.cc \
    ...
    -I ${NSYNC} -D_GLIBCXX_USE_CXX11_ABI=0
...
echo "--------------------------------------------------"
echo "Compile psroi pooling layer"
...
g++ -std=c++11 -shared -o deform_psroi_pooling.so deform_psroi_pooling_op.cc deform_psroi_pooling_op.cu.o -I \
    ...
    $CUDA_HOME/include -I ${NSYNC} -D_GLIBCXX_USE_CXX11_ABI=0
# for gcc5-built tf
...
echo "--------------------------------------------------"
echo "Compile deform conv layer"
