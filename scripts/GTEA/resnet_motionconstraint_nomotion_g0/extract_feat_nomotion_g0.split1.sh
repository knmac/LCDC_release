...
PRETRAIN_DIR="./logs/GTEA/Split_"$SPLIT"_snip16_stride4_frs1_mix/"$NETNAME"_nomotion_g0_test/best"
OUTPUTDIR="./data/GTEA/tcnfeat/"$NETNAME"_nomotion_g0/Split_"$SPLIT
