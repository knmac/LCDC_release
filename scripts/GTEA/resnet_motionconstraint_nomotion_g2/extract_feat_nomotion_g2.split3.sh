...
PRETRAIN_DIR="./logs/GTEA/Split_"$SPLIT"_snip16_stride4_frs1_mix/"$NETNAME"_nomotion_g2_test/best"
OUTPUTDIR="./data/GTEA/tcnfeat/"$NETNAME"_nomotion_g2/Split_"$SPLIT
